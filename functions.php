...
function moose_frame_setup() {
	...
	add_image_size( 'roadmap-size', 360, 271, true );
...
function moose_frame_scripts() {
	...
	wp_enqueue_style( 'moose-masonry-media-query-style', get_template_directory_uri() . '/_masonry-css/style-masonry.css', '', '1.0' );
	...
	wp_enqueue_script( 'moose-masonry-script-js', get_template_directory_uri() . '/_masonry-js/moose-masonry-script.js', array(), '20120206', true );
...
/*----------  Setting Number of Product Columns   ----------*/
